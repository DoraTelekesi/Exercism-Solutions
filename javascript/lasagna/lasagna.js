...
export function remainingMinutesInOven(actualMinutesInOven) {
  console.log("remainigTimesInOven",EXPECTED_MINUTES_IN_OVEN - actualMinutesInOven);
...
export function preparationTimeInMinutes(numberOfLayers) {
  console.log("preparationTimeInMinutes", numberOfLayers*PREPARATION_MINUTES_PER_LAYER)
...
export function totalTimeInMinutes(numberOfLayers, actualMinutesInOven) {
  console.log("TotalTimeInMinutes",preparationTimeInMinutes(numberOfLayers)+remainingMinutesInOven(actualMinutesInOven))
